...
`;var Wn=y("<span>"),Cn=y('<div><input class="override width100">');const Tn=x.div`
  * {
    user-select: none;
    -ms-user-select: none;
...
`,Ie=e=>{const[t,n]=U(!1),s=()=>{n(!0)},o=()=>{n(!1)},i=()=>t()?"wizardButtonInputHover":"wizardButtonInput";return d(Tn,{get class(){return`${i()} ${e.class??""}`},onFocus:s,onBlur:o,onMouseOver:s,onMouseOut:o,onClick:a=>{var l;a.preventDefault(),(l=e.onClick)==null||l.call(e)},tabIndex:0,role:"button",get children(){return[Wn(),(()=>{var a=Cn(),l=a.firstChild;return v(()=>b(l,"type",e.type??"submit")),v(()=>l.value=e.value),a})()]}})};var En=y('<input class="username field form-item"type=text name=username placeholder=Username>'),Bn=y('<input class="password field form-item"type=password name=password placeholder=Password>');const $n=()=>{const e=n=>{n.preventDefault();const s=new FormData(n.target),o=s.get("username"),i=s.get("password");I.useCredentials(o,i)},t=()=>{I.clearCredentials()};return d(An,{onSubmit:e,get children(){return[En(),Bn(),d(Ie,{value:"Use Credentials",class:"form-item"}),d(Ie,{value:"Clear Credentials",type:"button",onClick:t,class:"form-item"})]}})},Pn=x.span`
  width: 20px;
  height: 20px;
...
`;var zn=y('<div class=content-wrapper role=button><div class=content><div class=left><div class=scroll></div></div><div class=center><div class="text text-content"></div></div><div class=right><div class=scroll>');const Le=e=>d(Mn,{get class(){return e.class??""},get children(){var t=zn(),n=t.firstChild,s=n.firstChild,o=s.nextSibling,i=o.firstChild;return Ce(t,"focus",e.onClick),Ce(t,"click",e.onClick,!0),k(i,()=>e.content),t}});We(["click"]);var In=y("<div class=container-wrapper><div class=container>"),Ln=y("<div><div class=container>");const ft=x("div")`
  margin-top: 5px;
  position: relative;
...
`,Ne=e=>{if(!e.foldable)return d(ft,{get class(){return e.class},get children(){return[d(Le,{get content(){return e.titleContent},get class(){return e.titleClass}}),(()=>{var s=In(),o=s.firstChild;return k(o,()=>e.children),s})()]}});const t=new R(Boolean,e.foldable.localStorageKey,e.foldable.defaultFolded??!1),n=()=>{var s,o;console.log("onFold",t.get()),t.set(i=>!i),(o=(s=e.foldable).onFold)==null||o.call(s)};return d(ft,{get class(){return e.class},get children(){return[d(Le,{onClick:n,get content(){return e.titleContent},get class(){return e.titleClass}}),d(Se,{get when(){return!t.get()},get children(){var s=Ln(),o=s.firstChild;return k(o,()=>e.children),v(()=>Qe(s,`container-wrapper ${t.get()?"":"folded"}`)),s}})]}})};var Nn=y("<div class=modal><div class=top><div class=left></div><div class=center><div class=title></div><div class=content></div></div><div class=right></div></div><div class=bottom><div class=left><div class=corner><div class=corner-slope></div></div></div><div class=center></div><div class=right><div class=corner><div class=corner-slope>"),jn=y("<h1>");const Fn=e=>{const t=x.div`
  --side-width: 40px;
...
`;return d(n,{get class(){return e.isOpen?"":"close"}})},me=class me{constructor(){f(this,"backdropElmt");f(this,"modalElmt");this.backdropElmt=document.createElement("div"),this.backdropElmt.id="backdrop",this.modalElmt=document.createElement("div"),this.modalElmt.id="modal",document.body.appendChild(this.backdropElmt),document.body.appendChild(this.modalElmt)}static getInstance(){return this.instance||(this.instance=new me),this.instance}};f(me,"instance");let je=me;const Vn=(e,t)=>{const n=je.getInstance(),s=(t==null?void 0:t.openTimeMs)??300,o=new R(Boolean,"modalIsOpen"),[i,r]=U(o.get());Ae(()=>d(Se,{get when(){return i()},get children(){return d(Fn,{get title(){return t==null?void 0:t.title},onBackdropClick:l,get isOpen(){return o.get()},openTimeMs:s,get children(){return e(u)}})}}),n.modalElmt),Ae(()=>d(Se,{get when(){return i()},get children(){return d(Dn,{get opacity(){return t==null?void 0:t.backdropOpacityPercent},get isOpen(){return o.get()},openTimeMs:s})}}),n.backdropElmt),M(()=>{if(i()){document.body.style.overflowY="hidden";return}document.body.style.overflowY="auto"});const a=c=>{o.get()&&c.key==="Escape"&&u()};addEventListener("keydown",a);function l(c){c.currentTarget===c.target&&u()}function h(){o.set(!0),r(!0)}function u(){o.set(!1),setTimeout(()=>{r(!1)},s)}return{openModal:h,closeModal:u}};var Hn=y("<input>");const Gn=x.div`
  width: 26px;
  height: 26px;
  position: relative;
  cursor: pointer;
...
`,Rn=e=>{const t=e.type??"checkbox",n=s=>{var r;const i=s.target.checked;(r=e.onCheck)==null||r.call(e,i)};return d(Gn,{get class(){return e.class},get children(){var s=Hn();return s.$$click=n,b(s,"type",t),v(()=>b(s,"id",e.id)),v(()=>s.checked=e.checked),s}})};We(["click"]);const pe=class pe{static getId(){return`w101-trivia-bot-checkbox-${++pe.id}`}};f(pe,"id",0);let we=pe;var Un=y("<label>");const Kn=x.div`
  display: grid;
...
`,Yn=e=>{const t=e.name?e.name:we.getId();return d(Kn,{get class(){return e.class},get children(){return[d(Rn,{id:t,class:"checkbox",get onCheck(){return e.onCheck},get checked(){return e.checked}}),(()=>{var n=Un();return b(n,"for",t),k(n,()=>e.title),n})()]}})},Jn=e=>e.charAt(0).toUpperCase()+e.slice(1).toLowerCase();var Qn=y("<label>"),Xn=y("<textarea>"),Zn=y("<input>");const es=x.div`
  display: grid;
  grid-template-columns: 26px 1fr;
  align-items: center;
  grid-column-gap: 10px;
...
`,os=()=>d(ss,{get children(){return Pe.map(e=>typeof e=="string"?(()=>{var t=ts();return k(t,()=>e.split("_").map(n=>Jn(n)).join(" ")),t})():(()=>{var t=ns();return k(t,()=>e.map(n=>n instanceof ln?d(gt,{get title(){return n.title},get value(){return n.get()},onChange:s=>n.set(s),class:"input-group",get asTextarea(){var s;return(s=n.options)==null?void 0:s.asTextArea},get max(){var s;return(s=n.options)==null?void 0:s.max}}):n instanceof at?d(gt,{get title(){return n.title},type:"number",get max(){var s;return(s=n.options)==null?void 0:s.max},get min(){var s;return(s=n.options)==null?void 0:s.min},class:"input-group small",get value(){return n.get().toString()},onChange:s=>{let o=parseInt(s);if(!n.options){n.set(o);return}n.options.max&&(o=Math.min(o,n.options.max)),n.options.min&&(o=Math.max(o,n.options.min)),n.set(o)}}):d(Yn,{get title(){return n.title},get checked(){return n.get()},onCheck:s=>n.set(s)}))),t})())}}),is=()=>{const e=new R(String,"_grecaptcha",""),t=x.div`
    .clear-captcha input {
      color: ${()=>e.get().length!==0?"#dc3545":"#f5e2a8"};
    }
  `;return d(Ne,{titleContent:"Actions",foldable:{localStorageKey:"actions-panel"},get children(){return d(t,{get children(){return d(Ie,{class:"clear-captcha",value:"Clear Captcha Storage",onClick:()=>e.set("")})}})}})};var rs=y("<h2>Trivia Q # <!> / 12"),as=y("<h2>Trivia # <!> / 10");const ls=()=>{const e=x.div`
    h2 {
      margin-left: 10px;
      margin-top: 3px;
      margin-bottom: 3px;
    }
  `;return d(e,{get children(){return d(Ne,{titleContent:"Trivia data",foldable:{localStorageKey:"trivia-data-panel"},get children(){return[(()=>{var t=rs(),n=t.firstChild,s=n.nextSibling;return s.nextSibling,k(t,()=>ee.get(),s),t})(),(()=>{var t=as(),n=t.firstChild,s=n.nextSibling;return s.nextSibling,k(t,()=>fe.get(),s),t})()]}})}})};var cs=y("<div>Auto Login");const us=x("div")`
  margin-left: 13px;
  margin-right: 13px;
...
`,ds=()=>{const{openModal:e}=Vn(()=>d(os,{}),{title:"Trivia Bot Settings",backdropOpacityPercent:50}),t=d(hs,{get children(){return[cs(),d(On,{get visible(){return I.getLoggedIn()}})]}});return d(us,{get children(){return[d(Ne,{titleContent:t,get titleClass(){return I.getLoggedIn()?"logged-in":""},foldable:{localStorageKey:"login-panel"},get children(){return d($n,{})}}),d(Le,{onClick:e,content:"Trivia Bot Settings"}),d(is,{}),d(ls,{})]}})},fs=x("span")`
  .text-content {
...
`,gs=()=>d(fs,{get children(){return d(ds,{})}}),ws=async()=>{ee.clearValue();const e=()=>ce(L.second,L.second*2);await j(e());const t=document.querySelector(".kiaccountsbuttongreen");_(t,"Results button not found!"),t.click(),await j(e());const n=document.querySelector("#jPopFrame_content");_(n,"jPopFrame not found!");const s=n.contentWindow;_(s,"Content window not found!");const o=s.document.querySelector("#submit");_(o,"Submit button not found!"),fe.set(i=>i+1),o.click(),await j(L.second*2),M(()=>{A("others","attemptToPlaySounds")()&&Ee.done.play()})},ms=async()=>{fe.clearValue(),await j(L.minute),location.reload()};function ps(){const e=document.querySelector("dl");_(e,"Could not find parent element");const t=document.querySelector("#subMenu1_lockOpen");_(t,"Could not find before element");const n=document.createElement("div");e.insertBefore(n,t.nextSibling),Ae(()=>d(gs,{}),n),M(()=>{if(!A("login","autoLogin")())return;I.getLoggedIn();const s=I.autoLogin();return()=>{s&&clearTimeout(s)}}),M(()=>{if(Yt(),le.get==="searching"){hn();return}if(le.get==="quiz"){pn();return}if(le.get==="results"){ws();return}le.get==="end"&&ms()})}ps()});
