...
`,xe=e=>{const[t,n]=Y(!1),s=()=>{n(!0)},o=()=>{n(!1)},i=()=>t()?"wizardButtonInputHover":"wizardButtonInput";return h(sn,{get class(){return`${i()} ${e.class??""}`},onFocus:s,onBlur:o,onMouseOver:s,onMouseOut:o,onClick:r=>{var l;r.preventDefault(),(l=e.onClick)==null||l.call(e)},tabIndex:0,role:"button",get children(){return[tn(),(()=>{var r=nn(),l=r.firstChild;return v(()=>x(l,"type",e.type??"submit")),v(()=>l.value=e.value),r})()]}})};var on=p('<input class="username field form-item"type=text name=username placeholder=Username>'),rn=p('<input class="password field form-item"type=password name=password placeholder=Password>');const an=()=>{const e=n=>{n.preventDefault();const s=new FormData(n.target),o=s.get("username"),i=s.get("password");z.useCredentials(o,i)},t=()=>{z.clearCredentials()};return h(en,{onSubmit:e,get children(){return[on(),rn(),h(xe,{value:"Use Credentials",class:"form-item"}),h(xe,{value:"Clear Credentials",type:"button",onClick:t,class:"form-item"})]}})},ln=q.span`
  width: 20px;
  height: 20px;
...
`,vn=e=>{const t=e.type??"checkbox",n=s=>{var a;const i=s.target.checked;(a=e.onCheck)==null||a.call(e,i)};return h(qn,{get class(){return e.class},get children(){var s=bn();return s.$$click=n,x(s,"type",t),v(()=>x(s,"id",e.id)),v(()=>s.checked=e.checked),s}})};ge(["click"]);const ie=class ie{static getId(){return`w101-trivia-bot-checkbox-${++ie.id}`}};f(ie,"id",0);let se=ie;var _n=p("<label>");const kn=q.div`
  display: grid;
...
`,xn=e=>{const t=e.name?e.name:se.getId();return h(kn,{get class(){return e.class},get children(){return[h(vn,{id:t,class:"checkbox",get onCheck(){return e.onCheck},get checked(){return e.checked}}),(()=>{var n=_n();return x(n,"for",t),_(n,()=>e.title),n})()]}})},Sn=e=>e.charAt(0).toUpperCase()+e.slice(1).toLowerCase();var Wn=p("<input>"),An=p("<label>");const Cn=q.div`
  display: grid;
  grid-template-columns: 26px 1fr;
  align-items: center;
  grid-column-gap: 10px;
...
`,Tn=e=>{const t=e.name?e.name:se.getId(),n=s=>{var o;(o=e.onChange)==null||o.call(e,s.target.value)};return h(Cn,{get class(){return e.class},get children(){return[(()=>{var s=Wn();return s.addEventListener("change",n),x(s,"id",t),v(o=>{var i=e.type??"text",a=e.placeholder;return i!==o.e&&x(s,"type",o.e=i),a!==o.t&&x(s,"placeholder",o.t=a),o},{e:void 0,t:void 0}),v(()=>s.value=e.value),s})(),(()=>{var s=An();return x(s,"for",t),_(s,()=>e.title),s})()]}})};var En=p("<h3>"),Bn=p("<span class=setting-group>");const Pn=q.div`
...
`,$n=()=>h(Pn,{get children(){return be.map(e=>typeof e=="string"?(()=>{var t=En();return _(t,()=>e.split("_").map(n=>Sn(n)).join(" ")),t})():(()=>{var t=Bn();return _(t,()=>e.map(n=>n.type==="string"?h(Tn,{get title(){return n.title},get value(){return n.get()},onChange:s=>n.set(s)}):h(xn,{get title(){return n.title},get checked(){return n.get()},onCheck:s=>n.set(s)}))),t})())}}),Mn=()=>{const e=new H(String,"_grecaptcha",""),t=q.div`
    .clear-captcha input {
      color: ${()=>e.get().length!==0?"#dc3545":"#f5e2a8"};
    }
  `;return h(We,{titleContent:"Actions",foldable:{localStorageKey:"actions-panel"},get children(){return h(t,{get children(){return h(xe,{class:"clear-captcha",value:"Clear Captcha Storage",onClick:()=>e.set("")})}})}})};var In=p("<h2>Trivia Q # "),zn=p("<h2>Trivia # ");const Ln=()=>{const e=q.div`
    h2 {
      margin-left: 10px;
      margin-top: 3px;
      margin-bottom: 3px;
    }
  `;return h(e,{get children(){return h(We,{titleContent:"Trivia data",foldable:{localStorageKey:"trivia-data-panel"},get children(){return[(()=>{var t=In();return t.firstChild,_(t,()=>ke.get(),null),t})(),(()=>{var t=zn();return t.firstChild,_(t,()=>_e.get(),null),t})()]}})}})};var Nn=p("<div>Auto Login");const jn=q("div")`
  margin-left: 13px;
  margin-right: 13px;
