...
`;var tn=p("<span>"),nn=p('<div><input class="override width100">');const sn=q.div`
  * {
    user-select: none;
    -ms-user-select: none;
...
`,ke=e=>{const[t,n]=Y(!1),s=()=>{n(!0)},o=()=>{n(!1)},i=()=>t()?"wizardButtonInputHover":"wizardButtonInput";return h(sn,{get class(){return`${i()} ${e.class??""}`},onFocus:s,onBlur:o,onMouseOver:s,onMouseOut:o,onClick:r=>{var l;r.preventDefault(),(l=e.onClick)==null||l.call(e)},tabIndex:0,role:"button",get children(){return[tn(),(()=>{var r=nn(),l=r.firstChild;return v(()=>k(l,"type",e.type??"submit")),v(()=>l.value=e.value),r})()]}})};var on=p('<input class="username field form-item"type=text name=username placeholder=Username>'),rn=p('<input class="password field form-item"type=password name=password placeholder=Password>');const an=()=>{const e=n=>{n.preventDefault();const s=new FormData(n.target),o=s.get("username"),i=s.get("password");z.useCredentials(o,i)},t=()=>{z.clearCredentials()};return h(en,{onSubmit:e,get children(){return[on(),rn(),h(ke,{value:"Use Credentials",class:"form-item"}),h(ke,{value:"Clear Credentials",type:"button",onClick:t,class:"form-item"})]}})},ln=q.span`
  width: 20px;
  height: 20px;
...
`,cn=e=>h(ln,{get class(){return e.class},get style(){return{visibility:e.visible?"visible":"hidden"}}}),un=q("div")`
  margin-bottom: 15px;
...
`;var hn=p('<div class=content-wrapper role=button><div class=content><div class=left><div class=scroll></div></div><div class=center><div class="text text-content"></div></div><div class=right><div class=scroll>');const Se=e=>h(un,{get class(){return e.class??""},get children(){var t=hn(),n=t.firstChild,s=n.firstChild,o=s.nextSibling,i=o.firstChild;return we(t,"focus",e.onClick),we(t,"click",e.onClick,!0),_(i,()=>e.content),t}});ge(["click"]);var dn=p("<div class=container-wrapper><div class=container>"),fn=p("<div><div class=container>");const Xe=q("div")`
  margin-top: 5px;
  position: relative;
...
`,We=e=>{if(!e.foldable)return h(Xe,{get class(){return e.class},get children(){return[h(Se,{get content(){return e.titleContent},get class(){return e.titleClass}}),(()=>{var s=dn(),o=s.firstChild;return _(o,()=>e.children),s})()]}});const t=new H(Boolean,e.foldable.localStorageKey,e.foldable.defaultFolded??!1),n=()=>{var s,o;console.log("onFold",t.get()),t.set(i=>!i),(o=(s=e.foldable).onFold)==null||o.call(s)};return h(Xe,{get class(){return e.class},get children(){return[h(Se,{onClick:n,get content(){return e.titleContent},get class(){return e.titleClass}}),h(de,{get when(){return!t.get()},get children(){var s=fn(),o=s.firstChild;return _(o,()=>e.children),v(()=>Ne(s,`container-wrapper ${t.get()?"":"folded"}`)),s}})]}})};var gn=p("<div class=modal><div class=top><div class=left></div><div class=center><div class=title></div><div class=content></div></div><div class=right></div></div><div class=bottom><div class=left><div class=corner><div class=corner-slope></div></div></div><div class=center></div><div class=right><div class=corner><div class=corner-slope>"),wn=p("<h1>");const mn=e=>{const t=q.div`
  --side-width: 40px;
...
`;return h(t,{get onClick(){return e.onBackdropClick},get class(){return`${e.isOpen?"":"close"}`},id:"w101-trivia-bot-modal",get children(){var n=gn(),s=n.firstChild,o=s.firstChild,i=o.nextSibling,a=i.firstChild,r=a.nextSibling;return _(a,(()=>{var l=C(()=>!!e.title);return()=>l()&&(()=>{var d=wn();return _(d,()=>e.title),d})()})()),_(r,()=>e.children),n}})},pn=e=>{const t=Math.max(e.openTimeMs/2,100),n=q.div`
    @keyframes fadein {
      from {
        opacity: 0;
      }
...
`,vn=e=>{const t=e.type??"checkbox",n=s=>{var a;const i=s.target.checked;(a=e.onCheck)==null||a.call(e,i)};return h(qn,{get class(){return e.class},get children(){var s=bn();return s.$$click=n,k(s,"type",t),v(()=>k(s,"id",e.id)),v(()=>s.checked=e.checked),s}})};ge(["click"]);const ie=class ie{static getId(){return`w101-trivia-bot-checkbox-${++ie.id}`}};f(ie,"id",0);let se=ie;var _n=p("<label>");const xn=q.div`
  display: grid;
...
`,kn=e=>{const t=e.name?e.name:se.getId();return h(xn,{get class(){return e.class},get children(){return[h(vn,{id:t,class:"checkbox",get onCheck(){return e.onCheck},get checked(){return e.checked}}),(()=>{var n=_n();return k(n,"for",t),_(n,()=>e.title),n})()]}})},Sn=e=>e.charAt(0).toUpperCase()+e.slice(1).toLowerCase();var Wn=p("<input>"),An=p("<label>");const Cn=q.div`
  display: grid;
  grid-template-columns: 26px 1fr;
  align-items: center;
  grid-column-gap: 10px;
...
`,Tn=e=>{const t=e.name?e.name:se.getId(),n=s=>{var o;(o=e.onChange)==null||o.call(e,s.target.value)};return h(Cn,{get class(){return e.class},get children(){return[(()=>{var s=Wn();return s.addEventListener("change",n),k(s,"id",t),v(o=>{var i=e.type??"text",a=e.placeholder;return i!==o.e&&k(s,"type",o.e=i),a!==o.t&&k(s,"placeholder",o.t=a),o},{e:void 0,t:void 0}),v(()=>s.value=e.value),s})(),(()=>{var s=An();return k(s,"for",t),_(s,()=>e.title),s})()]}})};var En=p("<h3>"),Bn=p("<span class=setting-group>");const $n=q.div`
...
`,Pn=()=>h($n,{get children(){return be.map(e=>typeof e=="string"?(()=>{var t=En();return _(t,()=>e.split("_").map(n=>Sn(n)).join(" ")),t})():(()=>{var t=Bn();return _(t,()=>e.map(n=>n.type==="string"?h(Tn,{get title(){return n.title},get value(){return n.get()},onChange:s=>n.set(s)}):h(kn,{get title(){return n.title},get checked(){return n.get()},onCheck:s=>n.set(s)}))),t})())}}),Mn=()=>{const e=new H(String,"_grecaptcha",""),t=q.div`
    .clear-captcha input {
      color: ${()=>e.get().length!==0?"#dc3545":"#f5e2a8"};
    }
  `;return h(We,{titleContent:"Actions",foldable:{localStorageKey:"actions-panel"},get children(){return h(t,{get children(){return h(ke,{class:"clear-captcha",value:"Clear Captcha Storage",onClick:()=>e.set("")})}})}})};var In=p("<h2>Trivia Q # <!> / 12"),zn=p("<h2>Trivia # <!> / 10");const Ln=()=>{const e=q.div`
    h2 {
      margin-left: 10px;
      margin-top: 3px;
      margin-bottom: 3px;
    }
  `;return h(e,{get children(){return h(We,{titleContent:"Trivia data",foldable:{localStorageKey:"trivia-data-panel"},get children(){return[(()=>{var t=In(),n=t.firstChild,s=n.nextSibling;return s.nextSibling,_(t,()=>xe.get(),s),t})(),(()=>{var t=zn(),n=t.firstChild,s=n.nextSibling;return s.nextSibling,_(t,()=>_e.get(),s),t})()]}})}})};var Nn=p("<div>Auto Login");const jn=q("div")`
  margin-left: 13px;
  margin-right: 13px;
...
`,Fn=()=>{const{openModal:e}=yn(()=>h(Pn,{}),{title:"Trivia Bot Settings",backdropOpacityPercent:50}),t=h(On,{get children(){return[Nn(),h(cn,{get visible(){return z.getLoggedIn()}})]}});return h(jn,{get children(){return[h(We,{titleContent:t,get titleClass(){return z.getLoggedIn()?"logged-in":""},get children(){return h(an,{})}}),h(Se,{onClick:e,content:"Trivia Bot Settings"}),h(Mn,{}),h(Ln,{})]}})},Dn=q("span")`
  .text-content {
...
`,Hn=()=>h(Dn,{get children(){return h(Fn,{})}}),Gn=async()=>{xe.clearValue();const e=()=>te(L.second,L.second*2);await j(e());const t=document.querySelector(".kiaccountsbuttongreen");b(t,"Results button not found!"),t.click(),await j(e());const n=document.querySelector("#jPopFrame_content");b(n,"jPopFrame not found!");const s=n.contentWindow;b(s,"Content window not found!");const o=s.document.querySelector("#submit");b(o,"Submit button not found!"),_e.set(i=>i+1),o.click(),await j(L.second*2),M(()=>{S("others","attemptToPlaySounds")()&&pe.done.play()})},Vn=async()=>{_e.clearValue(),await j(L.minute),location.reload()};function Rn(){const e=document.querySelector("dl");b(e,"Could not find parent element");const t=document.querySelector("#subMenu1_lockOpen");b(t,"Could not find before element");const n=document.createElement("div");e.insertBefore(n,t.nextSibling),fe(()=>h(Hn,{}),n),M(()=>{if(!S("login","autoLogin")())return;z.getLoggedIn();const s=z.autoLogin();return()=>{s&&clearTimeout(s)}}),M(()=>{if($t(),ee.get==="searching"){Ot();return}if(ee.get==="quiz"){Vt();return}if(ee.get==="results"){Gn();return}ee.get==="end"&&Vn()})}Rn()});
