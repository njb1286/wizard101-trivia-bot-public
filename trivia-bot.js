...
`,ve=e=>{const[t,n]=Y(!1),s=()=>{n(!0)},o=()=>{n(!1)},i=()=>t()?"wizardButtonInputHover":"wizardButtonInput";return d(Zt,{get class(){return`${i()} ${e.class??""}`},onFocus:s,onBlur:o,onMouseOver:s,onMouseOut:o,onClick:r=>{var l;r.preventDefault(),(l=e.onClick)==null||l.call(e)},tabIndex:0,role:"button",get children(){return[Jt(),(()=>{var r=Xt(),l=r.firstChild;return v(()=>k(l,"type",e.type??"submit")),v(()=>l.value=e.value),r})()]}})};var en=b('<input class="username field form-item"type=text name=username placeholder=Username>'),tn=b('<input class="password field form-item"type=password name=password placeholder=Password>');const nn=()=>{const e=n=>{n.preventDefault();const s=new FormData(n.target),o=s.get("username"),i=s.get("password");$.useCredentials(o,i)},t=()=>{$.clearCredentials()};return d(Qt,{onSubmit:e,get children(){return[en(),tn(),d(ve,{value:"Use Credentials",class:"form-item"}),d(ve,{value:"Clear Credentials",type:"button",onClick:t,class:"form-item"})]}})},sn=q.span`
  width: 20px;
  height: 20px;
...
`,Ye=e=>d(cn,{get class(){return e.class},get children(){return[d(Ue,{get content(){return e.titleContent},get class(){return e.titleClass}}),(()=>{var t=ln(),n=t.firstChild;return C(n,()=>e.children),t})()]}});var un=b("<div class=modal><div class=top><div class=left></div><div class=center><div class=title></div><div class=content></div></div><div class=right></div></div><div class=bottom><div class=left><div class=corner><div class=corner-slope></div></div></div><div class=center></div><div class=right><div class=corner><div class=corner-slope>"),hn=b("<h1>");const dn=e=>{const t=q.div`
  --side-width: 40px;
...
`;return d(t,{get onClick(){return e.onBackdropClick},get class(){return`${e.isOpen?"":"close"}`},id:"w101-trivia-bot-modal",get children(){var n=un(),s=n.firstChild,o=s.firstChild,i=o.nextSibling,a=i.firstChild,r=a.nextSibling;return C(a,(()=>{var l=A(()=>!!e.title);return()=>l()&&(()=>{var h=hn();return C(h,()=>e.title),h})()})()),C(r,()=>e.children),n}})},fn=e=>{const t=Math.max(e.openTimeMs/2,100),n=q.div`
    @keyframes fadein {
      from {
        opacity: 0;
      }
...
`,pn=e=>{const t=e.type??"checkbox",n=s=>{var a;const i=s.target.checked;(a=e.onCheck)==null||a.call(e,i)};return d(mn,{get class(){return e.class},get children(){var s=wn();return s.$$click=n,k(s,"type",t),v(()=>k(s,"id",e.id)),v(()=>s.checked=e.checked),s}})};de(["click"]);const oe=class oe{static getId(){return`w101-trivia-bot-checkbox-${++oe.id}`}};f(oe,"id",0);let ne=oe;var yn=b("<label>");const bn=q.div`
  display: grid;
...
`,qn=e=>{const t=e.name?e.name:ne.getId();return d(bn,{get class(){return e.class},get children(){return[d(pn,{id:t,class:"checkbox",get onCheck(){return e.onCheck},get checked(){return e.checked}}),(()=>{var n=yn();return k(n,"for",t),C(n,()=>e.title),n})()]}})},vn=e=>e.charAt(0).toUpperCase()+e.slice(1).toLowerCase();var _n=b("<input>"),kn=b("<label>");const xn=q.div`
  display: grid;
  grid-template-columns: 26px 1fr;
  align-items: center;
  grid-column-gap: 10px;
...
`,Sn=e=>{const t=e.name?e.name:ne.getId(),n=s=>{var o;(o=e.onChange)==null||o.call(e,s.target.value)};return d(xn,{get class(){return e.class},get children(){return[(()=>{var s=_n();return s.addEventListener("change",n),k(s,"id",t),v(o=>{var i=e.type??"text",a=e.placeholder;return i!==o.e&&k(s,"type",o.e=i),a!==o.t&&k(s,"placeholder",o.t=a),o},{e:void 0,t:void 0}),v(()=>s.value=e.value),s})(),(()=>{var s=kn();return k(s,"for",t),C(s,()=>e.title),s})()]}})};var Wn=b("<h3>"),An=b("<span class=setting-group>");const Cn=q.div`
...
`,Tn=()=>d(Cn,{get children(){return ye.map(e=>typeof e=="string"?(()=>{var t=Wn();return C(t,()=>e.split("_").map(n=>vn(n)).join(" ")),t})():(()=>{var t=An();return C(t,()=>e.map(n=>n.type==="string"?d(Sn,{get title(){return n.title},get value(){return n.get()},onChange:s=>n.set(s)}):d(qn,{get title(){return n.title},get checked(){return n.get()},onCheck:s=>n.set(s)}))),t})())}}),En=()=>{const e=new me(String,"_grecaptcha",""),t=q.div`
    .clear-captcha input {
      color: ${()=>e.get().length!==0?"#dc3545":"#f5e2a8"};
    }
  `;return d(Ye,{titleContent:"Actions",get children(){return d(t,{get children(){return d(ve,{class:"clear-captcha",value:"Clear Captcha Storage",onClick:()=>e.set("")})}})}})};var Bn=b("<div>Auto Login");const Pn=q("div")`
  margin-left: 13px;
  margin-right: 13px;
...
`,In=()=>{const{openModal:e}=gn(()=>d(Tn,{}),{title:"Trivia Bot Settings",backdropOpacityPercent:50}),t=d(Mn,{get children(){return[Bn(),d(on,{get visible(){return $.getLoggedIn()}})]}});return d(Pn,{get children(){return[d(Ye,{titleContent:t,get titleClass(){return $.getLoggedIn()?"logged-in":""},get children(){return d(nn,{})}}),d(Ue,{onClick:e,content:"Trivia Bot Settings"}),d(En,{})]}})},zn=q("span")`
  .text-content {
...
`,$n=()=>d(zn,{get children(){return d(In,{})}}),Ln=async()=>{const e=()=>ee(L.second,L.second*2);await j(e());const t=document.querySelector(".kiaccountsbuttongreen");y(t,"Results button not found!"),t.click(),await j(e());const n=document.querySelector("#jPopFrame_content");y(n,"jPopFrame not found!");const s=n.contentWindow;y(s,"Content window not found!");const o=s.document.querySelector("#submit");y(o,"Submit button not found!"),o.click(),await j(L.second*2),I(()=>{x("others","attemptToPlaySounds")()&&we.done.play()})},Nn=async()=>{await j(L.minute),location.reload()};function jn(){const e=document.querySelector("dl");y(e,"Could not find parent element");const t=document.querySelector("#subMenu1_lockOpen");y(t,"Could not find before element");const n=document.createElement("div");e.insertBefore(n,t.nextSibling),he(()=>d($n,{}),n),I(()=>{if(!x("login","autoLogin")())return;$.getLoggedIn();const s=$.autoLogin();return()=>{s&&clearTimeout(s)}}),I(()=>{if(Tt(),Z.get==="searching"){Lt();return}if(Z.get==="quiz"){Ft();return}if(Z.get==="results"){Ln();return}Z.get==="end"&&Nn()})}jn()});
