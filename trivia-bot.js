...
`;var zn=y('<div class=content-wrapper role=button><div class=content><div class=left><div class=scroll></div></div><div class=center><div class="text text-content"></div></div><div class=right><div class=scroll>');const Ne=e=>d(Mn,{get class(){return e.class??""},get children(){var t=zn(),n=t.firstChild,s=n.firstChild,o=s.nextSibling,i=o.firstChild;return We(t,"focus",e.onClick),We(t,"click",e.onClick,!0),k(i,()=>e.content),t}});Ae(["click"]);var In=y("<div class=container-wrapper><div class=container>"),Nn=y("<div><div class=container>");const ft=x("div")`
  margin-top: 5px;
  position: relative;
...
`,Le=e=>{if(!e.foldable)return d(ft,{get class(){return e.class},get children(){return[d(Ne,{get content(){return e.titleContent},get class(){return e.titleClass}}),(()=>{var s=In(),o=s.firstChild;return k(o,()=>e.children),s})()]}});const t=new R(Boolean,e.foldable.localStorageKey,e.foldable.defaultFolded??!1),n=()=>{var s,o;console.log("onFold",t.get()),t.set(i=>!i),(o=(s=e.foldable).onFold)==null||o.call(s)};return d(ft,{get class(){return e.class},get children(){return[d(Ne,{onClick:n,get content(){return e.titleContent},get class(){return e.titleClass}}),d(ke,{get when(){return!t.get()},get children(){var s=Nn(),o=s.firstChild;return k(o,()=>e.children),v(()=>Qe(s,`container-wrapper ${t.get()?"":"folded"}`)),s}})]}})};var Ln=y("<div class=modal><div class=top><div class=left></div><div class=center><div class=title></div><div class=content></div></div><div class=right></div></div><div class=bottom><div class=left><div class=corner><div class=corner-slope></div></div></div><div class=center></div><div class=right><div class=corner><div class=corner-slope>"),jn=y("<h1>");const Fn=e=>{const t=x.div`
  --side-width: 40px;
...
`,os=()=>d(ss,{get children(){return $e.map(e=>typeof e=="string"?(()=>{var t=ts();return k(t,()=>e.split("_").map(n=>Jn(n)).join(" ")),t})():(()=>{var t=ns();return k(t,()=>e.map(n=>n instanceof ln?d(gt,{get title(){return n.title},get value(){return n.get()},onChange:s=>n.set(s),class:"input-group",get asTextarea(){var s;return(s=n.options)==null?void 0:s.asTextArea},get max(){var s;return(s=n.options)==null?void 0:s.max}}):n instanceof at?d(gt,{get title(){return n.title},type:"number",get max(){var s;return(s=n.options)==null?void 0:s.max},get min(){var s;return(s=n.options)==null?void 0:s.min},class:"input-group small",get value(){return n.get().toString()},onChange:s=>{let o=parseInt(s);if(!n.options){n.set(o);return}n.options.max&&(o=Math.min(o,n.options.max)),n.options.min&&(o=Math.max(o,n.options.min)),n.set(o)}}):d(Yn,{get title(){return n.title},get checked(){return n.get()},onCheck:s=>n.set(s)}))),t})())}}),is=()=>{const e=new R(String,"_grecaptcha",""),t=x.div`
  ...
  `;return d(Le,{titleContent:"Actions",foldable:{localStorageKey:"actions-panel"},get children(){return d(t,{get children(){return d(Ie,{class:"clear-captcha",value:"Clear Captcha Storage",onClick:()=>e.set("")})}})}})};var rs=y("<h2>Trivia Q # <!> / 12"),as=y("<h2>Trivia # <!> / 10");const ls=()=>{const e=x.div`
    h2 {
      margin-left: 10px;
      margin-top: 3px;
      margin-bottom: 3px;
...
`,gs=()=>d(fs,{get children(){return d(ds,{})}}),ws=async()=>{de.clearValue();const e=()=>le(N.second,N.second*2);await j(e());const t=document.querySelector(".kiaccountsbuttongreen");_(t,"Results button not found!"),t.click(),await j(e());const n=document.querySelector("#jPopFrame_content");_(n,"jPopFrame not found!");const s=n.contentWindow;_(s,"Content window not found!");const o=s.document.querySelector("#submit");_(o,"Submit button not found!"),Me.set(i=>i+1),o.click(),await j(N.second*2),M(()=>{A("others","attemptToPlaySounds")()&&Te.done.play()})},ms=async()=>{Me.clearValue(),await j(N.minute),location.reload()};function ps(){const e=document.querySelector("dl");_(e,"Could not find parent element");const t=document.querySelector("#subMenu1_lockOpen");_(t,"Could not find before element");const n=document.createElement("div");e.insertBefore(n,t.nextSibling),Se(()=>d(gs,{}),n),M(()=>{if(!A("login","autoLogin")())return;I.getLoggedIn();const s=I.autoLogin();return()=>{s&&clearTimeout(s)}}),M(()=>{if(Yt(),ae.get==="searching"){hn();return}if(ae.get==="quiz"){pn();return}if(ae.get==="results"){ws();return}ae.get==="end"&&ms()})}ps()});
