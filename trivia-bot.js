...
`,Ie=e=>d(Cn,{get class(){return e.class},onClick:()=>{var n;(n=e.onClick)==null||n.call(e)},get type(){return e.type??"button"},get children(){var n=Wn();return _(n,()=>e.value),n}});var Tn=y('<input class="username field form-item"type=text name=username placeholder=Username>'),En=y('<input class="password field form-item"type=password name=password placeholder=Password>');const Bn=()=>{const e=n=>{n.preventDefault(),console.log("Submitted!");const s=new FormData(n.target),o=s.get("username"),i=s.get("password");I.useCredentials(o,i)},t=()=>{I.clearCredentials()};return d(An,{onSubmit:e,get children(){return[Tn(),En(),d(Ie,{type:"submit",value:"Use Credentials",class:"form-item"}),d(Ie,{value:"Clear Credentials",type:"button",onClick:t,class:"form-item"})]}})},Pn=x.span`
  width: 20px;
  height: 20px;
...
`;return d(t,{get onClick(){return e.onBackdropClick},get class(){return`${e.isOpen?"":"close"}`},id:"w101-trivia-bot-modal",get children(){var n=jn(),s=n.firstChild,o=s.firstChild,i=o.nextSibling,r=i.firstChild,a=r.nextSibling;return _(r,(()=>{var l=S(()=>!!e.title);return()=>l()&&(()=>{var h=Ln();return _(h,()=>e.title),h})()})()),_(a,()=>e.children),n}})},Fn=e=>{const t=Math.max(e.openTimeMs/2,100),n=x.div`
    @keyframes fadein {
      from {
        opacity: 0;
      }
