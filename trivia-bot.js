...
`;return d(n,{get class(){return e.isOpen?"":"close"}})},we=class we{constructor(){f(this,"backdropElmt");f(this,"modalElmt");this.backdropElmt=document.createElement("div"),this.backdropElmt.id="backdrop",this.modalElmt=document.createElement("div"),this.modalElmt.id="modal",document.body.appendChild(this.backdropElmt),document.body.appendChild(this.modalElmt)}static getInstance(){return this.instance||(this.instance=new we),this.instance}};f(we,"instance");let je=we;const Vn=(e,t)=>{const n=je.getInstance(),s=(t==null?void 0:t.openTimeMs)??300,o=new R(Boolean,"modalIsOpen"),[i,r]=U(o.get());Se(()=>d(ke,{get when(){return i()},get children(){return d(Fn,{get title(){return t==null?void 0:t.title},onBackdropClick:l,get isOpen(){return o.get()},openTimeMs:s,get children(){return e(u)}})}}),n.modalElmt),Se(()=>d(ke,{get when(){return i()},get children(){return d(Dn,{get opacity(){return t==null?void 0:t.backdropOpacityPercent},get isOpen(){return o.get()},openTimeMs:s})}}),n.backdropElmt),M(()=>{if(i()){document.body.style.overflowY="hidden";return}document.body.style.overflowY="auto"});const a=c=>{o.get()&&c.key==="Escape"&&u()};addEventListener("keydown",a);function l(c){c.currentTarget===c.target&&u()}function h(){o.set(!0),r(!0)}function u(){o.set(!1),setTimeout(()=>{r(!1)},s)}return{openModal:h,closeModal:u}};var Hn=y("<input>");const Gn=x.div`
  width: 26px;
  height: 26px;
  position: relative;
  cursor: pointer;
...
`,Rn=e=>{const t=e.type??"checkbox",n=s=>{var r;const i=s.target.checked;(r=e.onCheck)==null||r.call(e,i)};return d(Gn,{get class(){return e.class},get children(){var s=Hn();return s.$$click=n,b(s,"type",t),v(()=>b(s,"id",e.id)),v(()=>s.checked=e.checked),s}})};Ae(["click"]);const me=class me{static getId(){return`w101-trivia-bot-checkbox-${++me.id}`}};f(me,"id",0);let ge=me;var Un=y("<label>");const Kn=x.div`
  display: grid;
...
`,os=()=>d(ss,{get children(){return $e.map(e=>typeof e=="string"?(()=>{var t=ts();return k(t,()=>e.split("_").map(n=>Jn(n)).join(" ")),t})():(()=>{var t=ns();return k(t,()=>e.map(n=>n instanceof ln?d(gt,{get title(){return n.title},get value(){return n.get()},onChange:s=>n.set(s),class:"input-group",get asTextarea(){var s;return(s=n.options)==null?void 0:s.asTextArea},get max(){var s;return(s=n.options)==null?void 0:s.max}}):n instanceof at?d(gt,{get title(){return n.title},type:"number",get max(){var s;return(s=n.options)==null?void 0:s.max},get min(){var s;return(s=n.options)==null?void 0:s.min},class:"input-group small",get value(){return n.get().toString()},onChange:s=>{let o=parseInt(s);if(!n.options){n.set(o);return}n.options.max&&(o=Math.min(o,n.options.max)),n.options.min&&(o=Math.max(o,n.options.min)),n.set(o)}}):d(Yn,{get title(){return n.title},get checked(){return n.get()},onCheck:s=>n.set(s)}))),t})())}}),is=()=>{const e=new R(String,"_grecaptcha",""),t=x.div`
    .clear-captcha input {
  ...
  `;return d(e,{get children(){return d(Ne,{titleContent:"Trivia data",foldable:{localStorageKey:"trivia-data-panel"},get children(){return[(()=>{var t=rs(),n=t.firstChild,s=n.nextSibling;return s.nextSibling,k(t,()=>de.get(),s),t})(),(()=>{var t=as(),n=t.firstChild,s=n.nextSibling;return s.nextSibling,k(t,()=>Me.get(),s),t})()]}})}})};var cs=y("<div>Auto Login");const us=x("div")`
  margin-left: 13px;
  margin-right: 13px;
...
`,gs=()=>d(fs,{get children(){return d(ds,{})}}),ws=async()=>{de.clearValue();const e=()=>le(L.second,L.second*2);await j(e());const t=document.querySelector(".kiaccountsbuttongreen");_(t,"Results button not found!"),t.click(),await j(e());const n=document.querySelector("#jPopFrame_content");_(n,"jPopFrame not found!");const s=n.contentWindow;_(s,"Content window not found!");const o=s.document.querySelector("#submit");_(o,"Submit button not found!"),Me.set(i=>i+1),o.click(),await j(L.second*2),M(()=>{A("others","attemptToPlaySounds")()&&Te.done.play()})},ms=async()=>{Me.clearValue(),await j(L.minute),location.reload()};function ps(){const e=document.querySelector("dl");_(e,"Could not find parent element");const t=document.querySelector("#subMenu1_lockOpen");_(t,"Could not find before element");const n=document.createElement("div");e.insertBefore(n,t.nextSibling),Se(()=>d(gs,{}),n),M(()=>{if(!A("login","autoLogin")())return;I.getLoggedIn();const s=I.autoLogin();return()=>{s&&clearTimeout(s)}}),M(()=>{if(Yt(),ae.get==="searching"){hn();return}if(ae.get==="quiz"){pn();return}if(ae.get==="results"){ws();return}ae.get==="end"&&ms()})}ps()});
