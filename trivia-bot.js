...
`;var zn=p('<div class=content-wrapper role=button><div class=content><div class=left><div class=scroll></div></div><div class=center><div class="text text-content"></div></div><div class=right><div class=scroll>');const je=e=>d(Mn,{get class(){return e.class??""},get children(){var t=zn(),n=t.firstChild,s=n.firstChild,o=s.nextSibling,i=o.firstChild;return Te(t,"focus",e.onClick),Te(t,"click",e.onClick,!0),k(i,()=>e.content),t}});Ce(["click"]);var In=p("<div class=container-wrapper><div class=container>"),jn=p("<div><div class=container>");const ft=x("div")`
  margin-top: 5px;
  position: relative;
...
`,os=()=>d(ss,{get children(){return Oe.map(e=>typeof e=="string"?(()=>{var t=ts();return k(t,()=>e.split("_").map(n=>Jn(n)).join(" ")),t})():(()=>{var t=ns();return k(t,()=>e.map(n=>n instanceof ln?d(gt,{get title(){return n.title},get value(){return n.get()},onChange:s=>n.set(s),class:"input-group",get asTextarea(){var s;return(s=n.options)==null?void 0:s.asTextArea},get max(){var s;return(s=n.options)==null?void 0:s.max}}):n instanceof at?d(gt,{get title(){return n.title},type:"number",get max(){var s;return(s=n.options)==null?void 0:s.max},get min(){var s;return(s=n.options)==null?void 0:s.min},class:"input-group small",get value(){return n.get().toString()},onChange:s=>{let o=parseInt(s);if(!n.options){n.set(o);return}n.options.max&&(o=Math.min(o,n.options.max)),n.options.min&&(o=Math.max(o,n.options.min)),n.set(o)}}):d(Yn,{get title(){return n.title},get checked(){return n.get()},onCheck:s=>n.set(s)}))),t})())}}),is=()=>{const e=new R(String,"_grecaptcha",""),t=x.div`
  ...
  `;return d(Le,{titleContent:"Actions",foldable:{localStorageKey:"actions-panel"},get children(){return d(t,{get children(){return d(Ie,{class:"clear-captcha",value:"Clear Captcha Storage",onClick:()=>e.set("")})}})}})};var rs=p("<h2>Trivia Q # <!> / 12"),as=p("<h2>Trivia # <!> / 10"),ls=p("<h2>Wrong Questions: ");const cs=()=>{const e=x.div`
    h2 {
      margin-left: 10px;
      margin-top: 3px;
      margin-bottom: 3px;
