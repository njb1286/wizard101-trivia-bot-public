...
`;var Wn=y("<div class=text>");const Cn=x.button`
...
`,Ie=e=>d(Cn,{get class(){return e.class},onClick:()=>{var n;(n=e.onClick)==null||n.call(e)},get type(){return e.type??"button"},get children(){var n=Wn();return _(n,()=>e.value),n}});var Tn=y('<input class="username field form-item"type=text name=username placeholder=Username>'),En=y('<input class="password field form-item"type=password name=password placeholder=Password>');const Bn=()=>{const e=n=>{n.preventDefault();const s=new FormData(n.target),o=s.get("username"),i=s.get("password");I.useCredentials(o,i)},t=()=>{I.clearCredentials()};return d(An,{onSubmit:e,get children(){return[Tn(),En(),d(Ie,{type:"submit",value:"Use Credentials",class:"form-item"}),d(Ie,{value:"Clear Credentials",type:"button",onClick:t,class:"form-item"})]}})},Pn=x.span`
  width: 20px;
  height: 20px;
...
`,$n=e=>d(Pn,{get class(){return e.class},get style(){return{visibility:e.visible?"visible":"hidden"}}}),zn=x("div")`
  margin-bottom: 15px;
...
`,Le=e=>{if(!e.foldable)return d(ft,{get class(){return e.class},get children(){return[d(je,{get content(){return e.titleContent},get class(){return e.titleClass}}),(()=>{var s=On(),o=s.firstChild;return _(o,()=>e.children),s})()]}});const t=new R(Boolean,e.foldable.localStorageKey,e.foldable.defaultFolded??!1),n=()=>{var s,o;t.set(i=>!i),(o=(s=e.foldable).onFold)==null||o.call(s)};return d(ft,{get class(){return e.class},get children(){return[d(je,{onClick:n,get content(){return e.titleContent},get class(){return e.titleClass}}),d(Ae,{get when(){return!t.get()},get children(){var s=In(),o=s.firstChild;return _(o,()=>e.children),k(()=>Qe(s,`container-wrapper ${t.get()?"":"folded"}`)),s}})]}})};var jn=y("<div class=modal><div class=top><div class=left></div><div class=center><div class=title></div><div class=content></div></div><div class=right></div></div><div class=bottom><div class=left><div class=corner><div class=corner-slope></div></div></div><div class=center></div><div class=right><div class=corner><div class=corner-slope>"),Ln=y("<h1>");const Nn=e=>{const t=x.div`
  --side-width: 40px;
...
`;return d(t,{get onClick(){return e.onBackdropClick},get class(){return`${e.isOpen?"":"close"}`},id:"w101-trivia-bot-modal",get children(){var n=jn(),s=n.firstChild,o=s.firstChild,i=o.nextSibling,r=i.firstChild,a=r.nextSibling;return _(r,(()=>{var l=S(()=>!!e.title);return()=>l()&&(()=>{var h=Ln();return _(h,()=>e.title),h})()})()),_(a,()=>e.children),n}})},Dn=e=>{const t=Math.max(e.openTimeMs/2,100),n=x.div`
    @keyframes fadein {
      from {
        opacity: 0;
      }
...
`,Gn=e=>{const t=e.type??"checkbox",n=s=>{var r;const i=s.target.checked;(r=e.onCheck)==null||r.call(e,i)};return d(Hn,{get class(){return e.class},get children(){var s=Vn();return s.$$click=n,q(s,"type",t),k(()=>q(s,"id",e.id)),k(()=>s.checked=e.checked),s}})};Ce(["click"]);const ye=class ye{static getId(){return`w101-trivia-bot-checkbox-${++ye.id}`}};f(ye,"id",0);let me=ye;var Rn=y("<label>");const Un=x.div`
  display: grid;
...
`,Kn=e=>{const t=e.name?e.name:me.getId();return d(Un,{get class(){return e.class},get children(){return[d(Gn,{id:t,class:"checkbox",get onCheck(){return e.onCheck},get checked(){return e.checked}}),(()=>{var n=Rn();return q(n,"for",t),_(n,()=>e.title),n})()]}})},Yn=e=>e.charAt(0).toUpperCase()+e.slice(1).toLowerCase();var Jn=y("<label>"),Qn=y("<textarea>"),Xn=y("<input>");const Zn=x.div`
  display: grid;
  grid-template-columns: 26px 1fr;
  align-items: center;
  grid-column-gap: 10px;
...
`,gt=e=>{const t=e.name?e.name:me.getId(),n=s=>{var o;(o=e.onChange)==null||o.call(e,s.target.value)};return d(Zn,{get class(){return e.class},get children(){return[S(()=>S(()=>!!e.asTextarea)()?(()=>{var s=Qn();return s.addEventListener("change",n),q(s,"id",t),k(o=>{var i=e.placeholder,r=e.max;return i!==o.e&&q(s,"placeholder",o.e=i),r!==o.t&&q(s,"maxlength",o.t=r),o},{e:void 0,t:void 0}),k(()=>s.value=e.value),s})():(()=>{var s=Xn();return s.addEventListener("change",n),q(s,"id",t),k(o=>{var i=e.type??"text",r=e.placeholder,a=e.max,l=e.max,h=e.min;return i!==o.e&&q(s,"type",o.e=i),r!==o.t&&q(s,"placeholder",o.t=r),a!==o.a&&q(s,"maxlength",o.a=a),l!==o.o&&q(s,"max",o.o=l),h!==o.i&&q(s,"min",o.i=h),o},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0}),k(()=>s.value=e.value),s})()),(()=>{var s=Jn();return q(s,"for",t),_(s,()=>e.title),s})()]}})};var es=y("<h3>"),ts=y("<span class=setting-group>");const ns=x.div`
...
`,ss=()=>d(ns,{get children(){return ze.map(e=>typeof e=="string"?(()=>{var t=es();return _(t,()=>e.split("_").map(n=>Yn(n)).join(" ")),t})():(()=>{var t=ts();return _(t,()=>e.map(n=>n instanceof ln?d(gt,{get title(){return n.title},get value(){return n.get()},onChange:s=>n.set(s),class:"input-group",get asTextarea(){var s;return(s=n.options)==null?void 0:s.asTextArea},get max(){var s;return(s=n.options)==null?void 0:s.max}}):n instanceof at?d(gt,{get title(){return n.title},type:"number",get max(){var s;return(s=n.options)==null?void 0:s.max},get min(){var s;return(s=n.options)==null?void 0:s.min},class:"input-group small",get value(){return n.get().toString()},onChange:s=>{let o=parseInt(s);if(!n.options){n.set(o);return}n.options.max&&(o=Math.min(o,n.options.max)),n.options.min&&(o=Math.max(o,n.options.min)),n.set(o)}}):d(Kn,{get title(){return n.title},get checked(){return n.get()},onCheck:s=>n.set(s)}))),t})())}}),os=()=>{const e=new R(String,"_grecaptcha",""),t=x.div`
    .clear-captcha {
      color: ${()=>e.get().length!==0?"#dc3545":"#f5e2a8"};
    }
  `;return d(Le,{titleContent:"Actions",foldable:{localStorageKey:"actions-panel"},get children(){return d(t,{get children(){return d(Ie,{class:"clear-captcha",value:"Clear Captcha Storage",onClick:()=>e.set("")})}})}})};var is=y("<h2>Trivia Q # <!> / 12"),rs=y("<h2>Trivia # <!> / 10"),as=y("<h2>Wrong Questions: ");const ls=()=>{const e=x.div`
    h2 {
      margin-left: 10px;
      margin-top: 3px;
      margin-bottom: 3px;
    }
  `;return d(e,{get children(){return d(Le,{titleContent:"Trivia data",foldable:{localStorageKey:"trivia-data-panel"},get children(){return[(()=>{var t=is(),n=t.firstChild,s=n.nextSibling;return s.nextSibling,_(t,()=>X.get(),s),t})(),(()=>{var t=rs(),n=t.firstChild,s=n.nextSibling;return s.nextSibling,_(t,()=>fe.get(),s),t})(),(()=>{var t=as();return t.firstChild,_(t,()=>ge.values.join(", "),null),t})()]}})}})};var cs=y("<div>Auto Login");const us=x("div")`
  margin-left: 13px;
  margin-right: 13px;
...
`,ds=()=>{const{openModal:e}=Fn(()=>d(ss,{}),{title:"Trivia Bot Settings",backdropOpacityPercent:50}),t=d(hs,{get children(){return[cs(),d($n,{get visible(){return I.getLoggedIn()}})]}});return d(us,{get children(){return[d(Le,{titleContent:t,get titleClass(){return I.getLoggedIn()?"logged-in":""},foldable:{localStorageKey:"login-panel"},get children(){return d(Bn,{})}}),d(je,{onClick:e,content:"Trivia Bot Settings"}),d(os,{}),d(ls,{})]}})},fs=x("span")`
  .text-content {
    font-family: Comic Sans, Comic Sans MS, Arial, Helvetica, sans-serif;
    font-weight: bold;
    color: #673f16;
...
`,gs=()=>d(fs,{get children(){return d(ds,{})}}),ws=async()=>{X.clearValue();const e=()=>le(j.second,j.second*2);await N(e());const t=document.querySelector(".kiaccountsbuttongreen");v(t,"Results button not found!"),t.click(),await N(e());const n=document.querySelector("#jPopFrame_content");v(n,"jPopFrame not found!");const s=n.contentWindow;v(s,"Content window not found!");const o=s.document.querySelector("#submit");v(o,"Submit button not found!"),fe.set(i=>i+1),o.click(),await N(j.second*2),M(()=>{A("others","attemptToPlaySounds")()&&Be.done.play()})},ms=async()=>{fe.clearValue(),await N(j.minute),location.reload()};function ps(){const e=document.querySelector("dl");v(e,"Could not find parent element");const t=document.querySelector("#subMenu1_lockOpen");v(t,"Could not find before element");const n=document.createElement("div");e.insertBefore(n,t.nextSibling),We(()=>d(gs,{}),n),M(()=>{if(!A("login","autoLogin")())return;I.getLoggedIn();const s=I.autoLogin();return()=>{s&&clearTimeout(s)}}),M(()=>{if(Yt(),ae.get==="searching"){hn();return}if(ae.get==="quiz"){pn();return}if(ae.get==="results"){ws();return}ae.get==="end"&&ms()})}ps()});
